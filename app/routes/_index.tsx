      ...
      <Reveal>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            <button
              type="submit"
              className="bg-gold-500 hover:bg-gold-400 text-vault-950 font-heading uppercase tracking-[0.2em] text-xs px-6 py-3 rounded-lg transition-all duration-200 hover:glow-gold-sm"
            >
              Subscribe
            </button>
          </form>
