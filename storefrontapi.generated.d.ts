...
export type FeaturedHeroProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FeaturedHeroProductQuery = {
...
> & {
  ...
  expectedShipDate?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value'>
  >;
  beybladeType?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  bladeName?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  ratchetSpec?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  bitSpec?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  series?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  modelNumber?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  condition?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  isLimitedEdition?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value'>
  >;
  generation?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #graphql\n  fragment Money on MoneyV2 {\n    amount\n    currencyCode\n  }\n\n  query FeaturedHeroProduct(\n    $country: CountryCode\n    $handle: String!\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      id\n      handle\n      title\n      featuredImage {\n        id\n        altText\n        url\n        width\n        height\n      }\n      priceRange {\n        minVariantPrice {\n          ...Money\n        }\n      }\n    }\n  }\n': {
    return: FeaturedHeroProductQuery;
    variables: FeaturedHeroProductQueryVariables;
  };
